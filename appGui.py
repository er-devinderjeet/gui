...
from func.graph import ohlcGraph
from ui.mainGui import Ui_mainWindow
from widgetOLSWindow import widgetOLSWindow
from backTestModeGui import backTestModeGui

from func.strategy.OLSStartegy import *
try:
...
class appGui(QtGui.QMainWindow,Ui_mainWindow):
    def __init__(self):
        ...
        self.ui.backTestModeButton.clicked.connect(self.app_Backtest_Mode_Button)
    ...
    def app_Backtest_Mode_Button(self):
        self.window_backtest_Mode_Obj = backTestModeGui()
        self.ui = Ui_mainWindow()
        self.window_backtest_Mode_Obj.show()
    '''
